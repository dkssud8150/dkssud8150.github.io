...
<img src="/assets/img/dev/week5/day1/graybmp.png" width="50%"><img src="/assets/img/dev/week5/day1/graydesc.png" width="50%">
...
byte 변환하는 방법으로는 cv2::imwrite()함수를 사용하면 된다. 나는 그냥 python으로 구해보았다.
