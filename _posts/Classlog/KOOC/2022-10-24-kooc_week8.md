...
<img src="/assets/img/kooc/wee78/single_gaussian_distribution.png">

이를 multi dimension으로 바꿀 때는 variance가 covariance matrix로 변환되어 만들어진다. μ값 또한, 벡터의 형태가 된다.

<img src="/assets/img/kooc/wee78/multi_gaussian_distribution.png">
...
<img src="/assets/img/kooc/wee78/log_multivariate_gaussian_distribution.png">

그리고 이 때, 사용되는 기법이 *trace trick* 이다. trace trick은 선형 대수에서 등장하는 기법으로 

<img src="/assets/img/kooc/wee78/trace_trick.png">

Trace trick은 위와 같이, `Tr` 이라는 기호를 통해 나타낸다.

&nbsp;

<img src="/assets/img/kooc/wee78/mle_log_multivariate.png">

이렇게 간단해진 식을 미분한다. 변수는 μ와 $\sum$ 이므로 이 둘에 대해 미분한다. trace_trick에 대해 미분하면 간단하게 값을 구할 수 있다.

<img src="/assets/img/kooc/wee78/trace_trick_deriative.png">
...
<img src="/assets/img/kooc/wee78/covariance_matrix.png">
...
<img src="/assets/img/kooc/wee78/mixture_model.png">
...
<img src="/assets/img/kooc/wee78/gaussian_mixture_model.png">
...
<img src="/assets/img/kooc/wee78/baysian_graph.png">
...
<img src="/assets/img/kooc/wee78/mle_estimation.png">
