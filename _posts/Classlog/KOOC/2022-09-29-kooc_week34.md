...
따라서 Gaussian Naive Bayes function은 Gaussian distribution을 feature 개수만큼 곱한 $ P(Y)\prod_{1 \leq i \leq d}P(X_i|Y) = \pi_k \prod_{1 \leq i \leq d} \cfrac{1}{\rho_k^iC} e^{-\cfrac{1}{2}(\cfrac{X_i - \mu_k^i}{\rho_k^i})^2} $ 가 된다.
...
$$ P(Y=y|X) = \cfrac{\pi_1 \prod_{1 \leq i \leq d} \cfrac{1}{\rho_1^iC} e^{-\cfrac{1}{2}(\cfrac{X_i - \mu_1^i}{\rho_1^i})^2}}{\pi_1 \prod_{1 \leq i \leq d} \cfrac{1}{\rho_i^iC} e^{-\cfrac{1}{2}(\cfrac{X_i - \mu_1^i}{\rho_1^i})^2} + \pi_2 \prod_{1 \leq i \leq d} \cfrac{1}{\rho_2^iC} e^{-\cfrac{1}{2}(\cfrac{X_i - \mu_2^i}{\rho_2^i})^2}} = \cfrac{1}{1+\cfrac{\pi_2 \prod_{1 \leq i \leq d} \cfrac{1}{\rho_2^iC} e^{-\cfrac{1}{2}(\cfrac{X_i - \mu_2^i}{\rho_2^i})^2}}{\pi_1 \prod_{1 \leq i \leq d} \cfrac{1}{\rho_1^iC} e^{-\cfrac{1}{2}(\cfrac{X_i - \mu_1^i}{\rho_1^i})^2}}}$$
