...
subtitle: "VoxelNet, a generic 3D detection network that unifies feature extraction and bounding box prediction into a single stage, end-to-end trainable deep network."
category: Classlog
tags:     Autonomous-Driving VoxelNet
image:
  path:   /assets/img/autodriving/voxelnet/fig6.png
---
